...
const specs: readonly CommandSpec[] = [
  ...
  { browserArguments: ["color:string"], commandUrl: ".uno:Color" },
  { browserArguments: ["color:string"], commandUrl: ".uno:CharBackColor" },
  { commandUrl: ".uno:Copy" },
  { commandUrl: ".uno:Cut" },
  ...
  { commandUrl: ".uno:InsertBookmark", showsDialog: true },
  { commandUrl: ".uno:InsertBreak", showsDialog: true },
  { commandUrl: ".uno:InsertPagebreak" },
  { commandUrl: ".uno:InsertTable", showsDialog: true },
  { commandUrl: ".uno:Italic", semantics: "check" },
  { browserArguments: ["percent:number"], commandUrl: ".uno:LineSpacing" },
  { commandUrl: ".uno:LineNumberingDialog", showsDialog: true },
  ...
  { commandUrl: ".uno:ParagraphDialog", showsDialog: true },
  { commandUrl: ".uno:DefaultNumbering", semantics: "radio" },
  { commandUrl: ".uno:ContinueNumbering" },
  { commandUrl: ".uno:Paste" },
  { commandUrl: ".uno:Print" },
...
const commandAliases = {
  ...
  bold: ".uno:Bold",
  color: ".uno:Color",
  charBackColor: ".uno:CharBackColor",
  copy: ".uno:Copy",
  cut: ".uno:Cut",
  ...
  insertBreak: ".uno:InsertBreak",
  insertPageBreak: ".uno:InsertPagebreak",
  insertTable: ".uno:InsertTable",
  headingOne: ".uno:StyleApply?Style:string=Heading%201&FamilyName:string=ParagraphStyles",
  italic: ".uno:Italic",
  lineSpacing: ".uno:LineSpacing",
  lineNumberingDialog: ".uno:LineNumberingDialog",
  increaseIndent: ".uno:IncrementIndent",
  newDocument: ".uno:AddDirect",
  openOdt: ".uno:Open",
  pageDialog: ".uno:PageDialog",
  paragraphDialog: ".uno:ParagraphDialog",
  orderedList: ".uno:DefaultNumbering",
  continueNumbering: ".uno:ContinueNumbering",
  paste: ".uno:Paste",
  print: ".uno:Print",
  ...
  underlineSingle: ".uno:UnderlineSingle",
  undo: ".uno:Undo",
...
const commandCapabilities: Readonly<Record<string, `CAP-${string}`>> = {
  ...
  ".uno:ContinueNumbering": "CAP-0105",
  ".uno:EditHyperlink": "CAP-0135",
  ".uno:EndPara": "CAP-0112",
  ".uno:ExportTo": "CAP-0101",
  ".uno:HyperlinkDialog": "CAP-0135",
  ".uno:InsertBookmark": "CAP-0113",
  ".uno:InsertBreak": "CAP-0112",
  ".uno:InsertPagebreak": "CAP-0112",
  ".uno:InsertTable": "CAP-0137",
  ".uno:IncrementLevel": "CAP-0107",
  ".uno:IncrementIndent": "CAP-0107",
  ".uno:Italic": "CAP-0109",
  ".uno:LineSpacing": "CAP-0125",
  ".uno:LineNumberingDialog": "CAP-0125",
  ".uno:JustifyPara": "CAP-0112",
  ".uno:Open": "CAP-0113",
  ".uno:PageDialog": "CAP-0136",
  ".uno:ParagraphDialog": "CAP-0125",
  ".uno:Paste": "CAP-0110",
  ".uno:Print": "CAP-0101",
  ".uno:Redo": "CAP-0102",
