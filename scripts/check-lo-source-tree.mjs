...
const requiredFiles = [
  ...
  "apps/office/src/sw/browser/persistence/item-codec.ts",
  "apps/office/src/sw/browser/persistence/writer-document-codec.ts",
  "apps/office/src/sw/browser/persistence/writer-storage.ts",
