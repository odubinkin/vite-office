 ...
 */, async function copiesFormattedWriterContent({ page }): Promise<void> {
  ...
  expect(clipboardPayload.html).toBe(
    '<p style="text-align: center; font-size: 1.5rem; font-weight: 700; line-height: 2.25rem;"><span style="font-family: Liberation Sans"><strong>Copied Writer heading</strong></span></p>',
  );
});
