...
export const WRITER_COMMAND_IDS = {
  ...
  metaRedo: "writer.metaRedo",
  metaUndo: "writer.metaUndo",
...
export const writerUserCommands: readonly WriterUserCommandInventoryRecord[] = [
  ...
  { capabilityId: "CAP-0102", id: WRITER_COMMAND_IDS.metaRedo, label: "Redo (Meta shortcut)" },
  { capabilityId: "CAP-0102", id: WRITER_COMMAND_IDS.metaUndo, label: "Undo (Meta shortcut)" },
